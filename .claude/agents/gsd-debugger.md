...
<required_reading>
@/opt/norish-src/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/opt/norish-src/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /opt/norish-src/.claude
                  → checks /opt/norish-src/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /opt/norish-src/.claude/gsd-core
                  → writes to /opt/norish-src/.claude/gsd-core/hooks/
...
@/opt/norish-src/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/opt/norish-src/.claude/gsd-core/references/common-bug-patterns.md
