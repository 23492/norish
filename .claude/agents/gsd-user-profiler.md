...
<reference>
@/opt/norish-src/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/opt/norish-src/.claude/gsd-core/references/user-profiling.md` to load:
