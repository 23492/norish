...
<execution_context>
@/opt/norish-src/.claude/gsd-core/workflows/settings.md
@/opt/norish-src/.claude/gsd-core/workflows/settings-advanced.md
@/opt/norish-src/.claude/gsd-core/workflows/settings-integrations.md
</execution_context>
