...
<execution_context>
@/opt/norish-src/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/opt/norish-src/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
