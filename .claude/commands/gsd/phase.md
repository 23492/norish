...
<execution_context>
@/opt/norish-src/.claude/gsd-core/workflows/add-phase.md
@/opt/norish-src/.claude/gsd-core/workflows/insert-phase.md
@/opt/norish-src/.claude/gsd-core/workflows/remove-phase.md
@/opt/norish-src/.claude/gsd-core/workflows/edit-phase.md
</execution_context>
