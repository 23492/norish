...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/opt/norish-src/.claude/.gsd-surface.json`
(sibling to `/opt/norish-src/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/opt/norish-src/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/opt/norish-src/.claude/skills`).
...
`/opt/norish-src/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/opt/norish-src/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/opt/norish-src/.claude/.gsd-surface.json`
Install profile marker: `/opt/norish-src/.claude/.gsd-profile`
Skill dirs: `/opt/norish-src/.claude/skills/gsd-*/`
Engine module: `/opt/norish-src/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/opt/norish-src/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
