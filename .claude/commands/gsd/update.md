...
<execution_context>
@/opt/norish-src/.claude/gsd-core/workflows/update.md
</execution_context>
...
@/opt/norish-src/.claude/gsd-core/workflows/sync-skills.md
@/opt/norish-src/.claude/gsd-core/workflows/reapply-patches.md
</execution_context_extended>
