...
- Usage: Reference from command with `@/opt/norish-src/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /opt/norish-src/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /opt/norish-src/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
