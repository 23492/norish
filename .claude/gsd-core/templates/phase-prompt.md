...
<!-- For checkpoint task examples and patterns, see @/opt/norish-src/.claude/gsd-core/references/checkpoints.md -->
...
See `/opt/norish-src/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/opt/norish-src/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/opt/norish-src/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
