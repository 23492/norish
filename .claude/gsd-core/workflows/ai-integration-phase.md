...
<required_reading>
@/opt/norish-src/.claude/gsd-core/references/ai-frameworks.md
@/opt/norish-src/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /opt/norish-src/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/opt/norish-src/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /opt/norish-src/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /opt/norish-src/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /opt/norish-src/.claude/agents/gsd-eval-planner.md for instructions.
