...
See /opt/norish-src/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /opt/norish-src/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /opt/norish-src/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /opt/norish-src/.claude/gsd-core/templates/discovery.md
...
Use /opt/norish-src/.claude/gsd-core/templates/discovery.md.
