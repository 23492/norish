...
<required_reading>
@/opt/norish-src/.claude/gsd-core/references/user-story-template.md
@/opt/norish-src/.claude/gsd-core/references/spidr-splitting.md
@/opt/norish-src/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/opt/norish-src/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/opt/norish-src/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/opt/norish-src/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
