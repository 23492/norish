...
Key references:
- @/opt/norish-src/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/opt/norish-src/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/opt/norish-src/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/opt/norish-src/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/opt/norish-src/.claude/gsd-core/USER-PROFILE.md" "/opt/norish-src/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /opt/norish-src/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/opt/norish-src/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/opt/norish-src/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /opt/norish-src/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /opt/norish-src/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /opt/norish-src/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /opt/norish-src/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /opt/norish-src/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/opt/norish-src/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /opt/norish-src/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /opt/norish-src/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /opt/norish-src/.claude/CLAUDE.md
```
