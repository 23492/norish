...
```markdown
Read /opt/norish-src/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /opt/norish-src/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /opt/norish-src/.claude/agents/gsd-ui-checker.md for instructions.
