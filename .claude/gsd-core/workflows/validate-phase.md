...
```
Agent(
  prompt="Read /opt/norish-src/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/opt/norish-src/.claude/gsd-core/templates/VALIDATION.md`
