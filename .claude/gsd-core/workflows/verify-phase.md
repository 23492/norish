...
<required_reading>
@/opt/norish-src/.claude/gsd-core/references/verification-patterns.md
@/opt/norish-src/.claude/gsd-core/templates/verification-report.md
</required_reading>
...
See /opt/norish-src/.claude/gsd-core/templates/verification-report.md for complete template.
</step>
