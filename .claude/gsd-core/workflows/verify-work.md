...
<template>
@/opt/norish-src/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/opt/norish-src/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/opt/norish-src/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/opt/norish-src/.claude/gsd-core/workflows/diagnose-issues.md
