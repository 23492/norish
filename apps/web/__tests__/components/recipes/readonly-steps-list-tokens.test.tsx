...
// SmartMarkdownRenderer (rendered transitively via SmartInstruction) now
// reads the timer fallback label via useTranslations("common") (Phase 27
// W4, T3, D-27-W4-06) instead of a hard-coded English string — this suite
// renders without a next-intl provider, so the hook needs a mock.
vi.mock("next-intl", () => ({
