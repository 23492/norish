...
- [ ] **Fix use-timer-keywords-query.ts default value**
...
- [ ] **Rewrite timer-keywords-editor.tsx component**
...
- [ ] **Fix content-detection-card.tsx props**
...
- [ ] **Fix admin context.tsx type usage**
...
- [ ] **Fix SmartInstruction parser call**
...
- [ ] **Fix seed-config.ts property references**
...
- [ ] **Rewrite timer-keywords-config.test.ts**
...
- [ ] **Add integration test for parser**
...
- [ ] **Understand rc/v0.16.0 implementation**
...
- [ ] **Add ingredient quantity parsing to SmartInstruction**
...
- [ ] **Format quantities and UOMs in rendered output**
...
- [ ] **Merge quantity formatting with timer detection**
...
- [ ] **Integrate with markdown rendering**
...
- [ ] **Add tests for quantity + timer integration**
...
- [ ] **Add timer keywords UI translation keys**
...
- [ ] **Translate to German (formal and informal)**
...
- [ ] **Optimize timer tick loop in timer-dock.tsx**
...
- [ ] **Add memoization to SmartInstruction parsing**
...
- [ ] **Add null checks in SmartInstruction**
...
- [ ] Admin can configure timer keywords in three categories
- [ ] Timer detection works in English, German, French, Dutch
- [ ] Ingredient highlighting restored and working
